...
const schema = yup.object().shape({
  ...
  dataConsulta: yup.date("É preciso passar uma data válida"),
  horaConsulta: yup.string(),
  descricaoProblema: yup
    .string()
    .required("Campo 'descrição do problema' é obrigatório")
  ...
  medicacao: yup
    .string()
    .required("'A medicação receitada' é obrigatória")
  ...
  dosagem: yup
    .string()
    .required("Campo 'Dosagem e Precauções' é obrigatório")
...
const validacoesConsulta = (request, response, next) => {
  try {
...
module.exports = validacoesConsulta;
